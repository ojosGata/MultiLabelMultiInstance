...
public class MLStatistics {
	...
	/**
	 * Phi matrix values in [-1,1] where -1 = inverse relation, 0 = no relation,
	 * 1 = direct relation.
	 */
	double phi[][] = null;
	/**
	 * Chi square matrix values where 0 = complete independence. Values larger
	 * than 6.63 show label dependence at 0.01 level of significance (99%).
	 * Values larger than 3.84 show label dependence at 0.05 level of
	 * significance (95%).
	 */
	double chi2[][] = null;

	/**
	 * Gets the Phi correlation matrix. It requires the method calculatePhiChi2
	...
	/**
	 * Computes the skewRatio as peak/base. It requires the method
	 * calculateStats to be previously called.
	 * 
	 * @return double
	 */
