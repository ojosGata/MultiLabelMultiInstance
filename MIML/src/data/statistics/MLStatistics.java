...
public class MLStatistics
   ...
   * = direct relation. */
  double phi[][] = null;
  /** Chi square matrix values where 0 = complete independence. Values larger
   * than 6.63 show label dependence at 0.01 level of significance (99%). Values
   * larger than 3.84 show label dependence at 0.05 level of significance (95%). */
  double chi2[][] = null;
  ...
  /** Gets the Chi2 correlation matrix. It requires the method calculatePhiChi2
  ...
  public void calculateStats(MultiLabelInstances mlDataSet)
    ...
    for (int i = 0; i < numExamples; i++)
      ...
      double labelComb[] = new double[numLabels]; // labelset of the current
                                                  // label
   ...
   * frequencies. It requires the method calculateStats to be previously called.
   * 
  ...
  public double[][] calculateCoocurrence(MultiLabelInstances mlDataSet)
    ...
    for (int k = 0; k < numExamples; k++)
      ...
      for (int i = 0; i < numLabels; i++)
        ...
        for (int j = 0; j < numLabels; j++)
          {
          if ((i < j) && (temp.stringValue(labelIndices[i]).equals("1") && temp.stringValue(labelIndices[j]).equals("1")))
            {
   ...
   * It prints int(1/step) + 1 pairs of values. The first value of each pair is
   * the phi value and the second is the average number of labels that correlate
   * to the rest of the labels with correlation higher than the specified Phi
   * value. It requires the method calculatePhi to be previously called.
   *
   * @param step
  ...
  public double[] innerClassIR()
    { // IR for each label: negativePatterns/positivePatterns
   ...
   * 
   * @see Jesse Read. 2010. Scalable Multi-label Classification. Ph.D.
   ...
   * frequently occurring labelset. It requires the method calculateStats to be
   * previously called.
   * 
   * @see Jesse Read. 2010. Scalable Multi-label Classification. Ph.D.
   *      Dissertation. University of Waikato.
   ...
   * majorityLabelSet)/(patterns of the labelSet). Itrequires the method
   * calculateStats to be previously called.
   * 
  ...
  /** Computes the skewRatio as peak/base. It requires the method calculateStats
   * to be previously called.
   * 
   * @return double */
